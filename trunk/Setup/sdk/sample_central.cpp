...
static const BBWinAgentInfo_t 	sampleAgentInfo =
{
	...
	"sample_central",    					     // agentName;
	"This is a sample bbwin central mode testing/sample agent",  // agentDescription;
...
void 	AgentSample::Run() {
	...
	reportData << "Sample monitoring central-mode agent\n" << endl;
